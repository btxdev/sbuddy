      ...
      <div class='container background-main'>
        <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12' style='margin-top: 100px; margin-bottom: 100px;'>
          ...
          <div class='Acquaintance-title' style='text-align: center;'>
            ...
            <div class='Acquaintance-title-texth4'>Онлайн обучение</div>
          </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3 col-xl-3">
					<div class='onlinelearning-date'>
 						<div class='onlinelearning-date-elem' id='tt-online-list'>
						...
						<div class='onlinelearning-date-elem'>
							...
							<div class='onlinelearning-date-elem-elem'>
								<script>
									Timetable.online.field.dateSelect = '<?=$d6BRu4Xw0rEs5YJ2Gpjr;?>';
									$(document).ready(function() {
									  Timetable.online.list();
									  $('#' + Timetable.online.field.dateSelect).on('change', function() {
									    Timetable.online.dateSelect();
									  });
									});
								</script>
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-9 col-xl-9">
 					<div class='onlinelearning-date'>
						<div class='onlinelearning-date-elem' style='overflow-y: auto;'>
							<div class='onlinelearning-date-elem-title' date='01.01.1970' id='tt-online-date'>Расписание на вторник</div>
							<div class='onlinelearning-date-elem-block' id='tt-online-table'>
							</div>
						</div>
					</div>
        </div>
